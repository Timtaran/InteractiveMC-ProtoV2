 ...
 */
package net.timtaran.interactivemc.physics.config;

import dev.architectury.platform.Platform;
import net.timtaran.interactivemc.physics.config.subsystems.VxClientConfig;
import net.timtaran.interactivemc.physics.config.subsystems.VxNetworkConfig;
import net.timtaran.interactivemc.physics.config.subsystems.VxPhysicsConfig;
import net.timtaran.interactivemc.physics.config.subsystems.VxTerrainConfig;
