...
public final class VxPhysicsWorld implements Runnable, Executor {
    public static final int SIMULATION_HZ = 60;
    public static final float FIXED_TIME_STEP = 1.0f / SIMULATION_HZ;
    public static final float MAX_ACCUMULATED_TIME = 5.0f * FIXED_TIME_STEP;
