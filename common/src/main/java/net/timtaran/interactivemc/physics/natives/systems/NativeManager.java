 ...
 */
package net.timtaran.interactivemc.physics.natives.systems;

import dev.architectury.platform.Platform;
import net.timtaran.interactivemc.physics.natives.NativeLoader;
import net.timtaran.interactivemc.physics.natives.os.Arch;
import net.timtaran.interactivemc.physics.natives.os.OS;
import net.timtaran.interactivemc.physics.natives.os.UnsupportedOperatingSystemException;
