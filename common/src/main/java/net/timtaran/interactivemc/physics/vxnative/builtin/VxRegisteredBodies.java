 ...
 */
package net.timtaran.interactivemc.physics.vxnative.builtin;

import net.fabricmc.api.EnvType;
import net.fabricmc.api.Environment;
import net.minecraft.resources.ResourceLocation;
import net.timtaran.interactivemc.physics.vxnative.builtin.block.BlockRenderer;
import net.timtaran.interactivemc.physics.vxnative.builtin.block.BlockRigidBody;
import net.timtaran.interactivemc.physics.vxnative.builtin.box.BoxRenderer;
import net.timtaran.interactivemc.physics.vxnative.builtin.box.BoxRigidBody;
import net.timtaran.interactivemc.physics.vxnative.builtin.marble.MarbleRenderer;
import net.timtaran.interactivemc.physics.vxnative.builtin.marble.MarbleRigidBody;
import net.timtaran.interactivemc.physics.vxnative.item.chaincreator.body.VxChainPartRenderer;
import net.timtaran.interactivemc.physics.vxnative.item.chaincreator.body.VxChainPartRigidBody;
...
import net.timtaran.interactivemc.physics.vxnative.physics.ragdoll.body.VxBodyPartRigidBody;
import net.timtaran.interactivemc.physics.vxnative.physics.ragdoll.body.VxRagdollBodyPartRenderer;
