 ...
 */
package net.timtaran.interactivemc.physics.vxnative.config;

import dev.architectury.platform.Platform;
import net.timtaran.interactivemc.physics.vxnative.config.subsystems.VxClientConfig;
import net.timtaran.interactivemc.physics.vxnative.config.subsystems.VxNetworkConfig;
import net.timtaran.interactivemc.physics.vxnative.config.subsystems.VxPhysicsConfig;
import net.timtaran.interactivemc.physics.vxnative.config.subsystems.VxTerrainConfig;
