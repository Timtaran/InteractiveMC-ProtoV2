...
import net.timtaran.interactivemc.physics.vxnative.init.registry.ModRegistries;
import net.timtaran.interactivemc.physics.vxnative.natives.VxNativeManager;
import net.timtaran.interactivemc.physics.vxnative.network.VxPacketRegistry;
