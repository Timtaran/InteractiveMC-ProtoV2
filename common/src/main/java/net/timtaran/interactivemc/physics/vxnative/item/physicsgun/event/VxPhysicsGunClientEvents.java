 ...
 */
package net.timtaran.interactivemc.physics.vxnative.item.physicsgun.event;

import dev.architectury.event.EventResult;
import net.minecraft.client.Minecraft;
import net.timtaran.interactivemc.physics.vxnative.event.api.VxKeyEvent;
import net.timtaran.interactivemc.physics.vxnative.init.registry.ItemRegistry;
