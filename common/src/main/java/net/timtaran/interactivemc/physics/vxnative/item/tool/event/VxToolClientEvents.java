 ...
 */
package net.timtaran.interactivemc.physics.vxnative.item.tool.event;

import dev.architectury.event.EventResult;
import net.minecraft.client.Minecraft;
import net.minecraft.world.item.Item;
import net.timtaran.interactivemc.physics.vxnative.init.registry.KeyMappings;
import net.timtaran.interactivemc.physics.vxnative.event.api.VxKeyEvent;
import net.timtaran.interactivemc.physics.vxnative.event.api.VxMouseEvent;
import net.timtaran.interactivemc.physics.vxnative.item.tool.VxToolMode;
import net.timtaran.interactivemc.physics.vxnative.item.tool.gui.VxToolConfigScreen;
import net.timtaran.interactivemc.physics.vxnative.item.tool.packet.VxToolActionPacket;
