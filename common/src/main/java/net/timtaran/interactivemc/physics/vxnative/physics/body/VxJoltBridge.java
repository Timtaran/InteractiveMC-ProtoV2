package net.timtaran.interactivemc.physics.vxnative.physics.body;/*
 * This file is part of Velthoric.
 * Licensed under LGPL 3.0.
 */
<<<<<<<< HEAD:common/src/main/java/net/timtaran/interactivemc/physics/physics/body/manager/VxJoltBridge.java
package net.timtaran.interactivemc.physics.physics.body.manager;
========
package net.timtaran.interactivemc.physics.physics.body;
>>>>>>>> upstream/master:common/src/main/java/net/timtaran/interactivemc/physics/physics/body/VxJoltBridge.java
...
import net.timtaran.interactivemc.physics.vxnative.physics.body.type.VxRigidBody;
...
import net.timtaran.interactivemc.physics.vxnative.physics.body.type.factory.VxSoftBodyFactory;
