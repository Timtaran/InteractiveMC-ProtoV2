package net.timtaran.interactivemc.physics.vxnative.physics.lifecycle;/*
 * This file is part of Velthoric.
 * Licensed under LGPL 3.0.
 */
<<<<<<<< HEAD:common/src/main/java/net/timtaran/interactivemc/physics/physics/VxLifecycleEvents.java
package net.timtaran.interactivemc.physics.physics;

import dev.architectury.event.events.common.TickEvent;
import net.minecraft.server.level.ServerLevel;
import net.timtaran.interactivemc.physics.vxnative.event.api.VxLevelEvent;
import net.timtaran.interactivemc.physics.vxnative.event.api.VxServerLifecycleEvent;
...
>>>>>>>> upstream/master:common/src/main/java/net/timtaran/interactivemc/physics/physics/lifecycle/VxServerLifecycleHandler.java
