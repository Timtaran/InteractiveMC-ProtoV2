package net.timtaran.interactivemc.physics.vxnative.util;/*
 * This file is part of Velthoric.
 * Licensed under LGPL 3.0.
 */
<<<<<<<< HEAD:common/src/main/java/net/timtaran/interactivemc/physics/physics/body/client/time/VxFrameTimer.java
package net.timtaran.interactivemc.physics.physics.body.client.time;
========
package net.timtaran.interactivemc.physics.util;
>>>>>>>> upstream/master:common/src/main/java/net/xmx/velthoric/util/VxFrameTimer.java
